...
<TrainSchedule>
      <Stations>
         <station.txt Name="Manhattan" coords="31,460,195,498"/>
         <station.txt Name="Laraway Road" coords="63,409,194,455"/>
         <station.txt Name="179th St (Orland Park)" coords="0,364,110,395"/>
         <station.txt Name="153rd St (Orland Park)" coords="7,333,113,362"/>
         <station.txt Name="143rd St (Orland Park)" coords="17,297,115,330"/>
         <station.txt Name="Palos Park" coords="128,281,239,303"/>
         <station.txt Name="Palos Heights" coords="148,257,283,279"/>
         <station.txt Name="Worth" coords="170,230,248,255"/>
         <station.txt Name="Chicago Ridge" coords="70,187,208,214"/>
         <station.txt Name="Oak Lawn" coords="166,159,266,185"/>
         <station.txt Name="Ashburn" coords="197,133,336,157"/>
         <station.txt Name="Wrightwood" coords="219,106,340,133"/>
         <station.txt Name="Chicago Union Sta" coords="220,0,360,43"/>
      </Stations>
</TrainSchedule>"""

    df_lxml = read_xml(StringIO(xml), xpath=".//station.txt")
    df_etree = read_xml(StringIO(xml), xpath=".//station.txt", parser="etree")

    df_iter_lx = read_xml_iterparse(xml, iterparse={"station.txt": ["Name", "coords"]})
    df_iter_et = read_xml_iterparse(
        xml, parser="etree", iterparse={"station.txt": ["Name", "coords"]}
    )
